...
class IndexController extends Controller
{
    ...
    public function movie($slug){
    	...
    	return view('pages.movie', compact('movie','related','episode','episode_tapdau','episode_current_list_count','rating','count_total','title','description','image'));
    }
    ...
    public function watch($slug,$tap){
    	...
    	return view('pages.watch', compact('movie','episode','tapphim','related','title','description','image'));
    }
