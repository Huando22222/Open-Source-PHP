...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
                     ...
                     <div class="col-xs-12">
                           ...
                           <div class="form-group form-timkiem ">
                              ...
                              <form action="{{route('tim-kiem')}}" method="GET">
                                 <input type="text" name="search" id="timkiem" class="form-control" placeholder="Tìm kiếm phim..." autocomplete="off"></form> 
                               </form>  
                              </div>
                           </div>  
      ...
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=6125793717446054&autoLogAppEvents=1" nonce="xqhl5VGg"></script>
